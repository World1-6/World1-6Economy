...
public class Currency {
    ...
    public Currency(String name, UUID uuid, boolean defaultCurrency, MobDropManager mobDropManager, String symbol, String currencyNameSingular, String currencyNamePlural, Material itemMaterial, String color, double defaultMoney) {
        this.name = name;
        this.uuid = uuid;
